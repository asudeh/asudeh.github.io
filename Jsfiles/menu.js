...
function menu() {
st='<p align="center"><img width="82%" src="ppl/abol.jpg" class="niceBox">';
st+='<font size="6vm">Abolfazl Asudeh</font><br><font size="vm">Ph.D., Computer Science</font><br><font size="3vm">Postdoctoral Research Fellow<br><a href="http://www.cse.umich.edu/" target=_blank>Department of Computer Science and Engineering</a><br><a href="http://www.umich.edu" target=_blank>University of Michigan Ann Arbor</a></font></p>';
st += '<p><nav id="cssmenu"><ul>';
